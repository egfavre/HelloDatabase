...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //the wrong way to insert data from a user
//        String name = "', TRUE, 0, 0); DROP TABLE players --";
//        stmt.execute(String.format("INSERT INTO players VALUES (NULL, '%s', TRUE, 0, 100)", name));

        //the right way to insert data from a user
        //can scan for single quote and escape
        //better solution: PreparedStatement
        String name = "Charlie";
        ...
        //SELECT * to just look at all of them, but not best option
        ...
        while (results.next()){
            ...
            String name2 = results.getNString("name");
